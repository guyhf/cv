...
\employer{\textbf{Foresite Capital Management}}
...
\item{Languages:  Python, R, SQL, HTML5, CSS3, C, Ruby, Perl, MATLAB, \LaTeX{}.}
\item{Platforms: AWS, Unix (Linux, Solaris, OS X), Windows.}
\end{listitems}
